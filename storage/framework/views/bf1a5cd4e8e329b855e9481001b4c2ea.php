...
<div class="card">
  <div class="card-body">
    ...
    <form action="<?php echo e(route('estados-producto.update', $estado)); ?>" method="POST">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nicole\mercado-agricola\resources\views/estados/edit.blade.php ENDPATH**/ ?>